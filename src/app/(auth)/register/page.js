...
const Register = () => {  
  ...
  async function handleRegister(userInfo) {
    ...
    return(
        <main>
        <div className=" ">
          <form className=" w-auto gap-10 flex justify-center" action={handleRegister}>
            ...
            <div className="w-[300px] ">
              ...
              <div className="mb-5">
                ...
                <select name="gender" id="gender" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                  required>
